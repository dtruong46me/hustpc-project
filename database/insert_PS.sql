...
100 - 240 V 47 - 63 Hz
+3.3V@20A, +5V@20A, +12V@70.8A, +5VSB@3A', 'category7', 999),
...
Ten-year warranty for complete peace of mind.','category7',999),
...
[Stable +12V Output] DC-DC structure, Full Bridge LLC resonance assist, 12V synchronous rectification provide stable & safe output.','category7',999),
...
use of more energy efficient sleep states.','category7',999),
...
Full Modular
80 PLUS GOLD Certified
+3.3V@25A, +5V@25A, +12V@83.3A, -12V@0.3A, +5VSB@3A','category7',999),
...
80 PLUS Certified
100 - 240 V 50/60 Hz
+3.3V@20A, +5V@15A, +12V@35A, -12V@0.5A, +5VSB@2.5A','category7',999),
...
120mm Ultra Silent Fluid Dynamic Bearing Fan','category7',999),
...
80 PLUS GOLD Certified
100 - 240 V 47 - 63 Hz
+3.3V@20A, +5V@20A, +12V@83.3A, +5VSB@3A','category7',999),
...
Fully modular etched cables keep your rig neat and tidy.','category7',999),
...
Resonant LLC Topology with DC-to-DC Conversion.','category7',999),
   
("PS-014", 'CORSAIR RM Series RM750 750 W ATX 80 PLUS GOLD Certified Full Modular Power Supply',
'ATX
Full Modular
80 PLUS GOLD Certified','category7',999),
...
SLI & CrossFire Ready
Silent 135mm Fan
Strong Single +12V Rail','category7',999),
...
Supports standard SFX form factor and ATX via included bracket','category7',999),
...
Multiple circuitry protection of OVP, UVP, OPP, SCP and OTP','category7',999),
