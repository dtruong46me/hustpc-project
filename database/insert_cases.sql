...
INSERT INTO products (product_id, pname, description, category_id, qty_in_store) VALUES
    ("CASE-001", "Corsair 4000D Airflow CC-9011200-WW Black Steel / Plastic / Tempered Glass ATX Mid Tower Computer Case", "A Fitting Choice
High-Airflow Front Panel
CORSAIR RapidRoute Cable Management System
Two Included 120mm Fans
Extreme Cooling Potential
Modern Front Panel I/O: Including a USB 3.1 Type-C Port, USB 3.0 port, and a combination audio/microphone jack.
All the Storage You Need: Fits up to 2x SSDs and 2x HDDs.
Tool-Free Tempered Glass Side Panel: Show off your high-profile components and RGB lighting.", "category6",999 ),
    ("CASE-002", "Corsair iCUE 4000X RGB CC-9011204-WW Black Steel / Plastic / Tempered Glass ATX Mid Tower Computer Case
...
All the Storage You Need: Fits up to 2x SSDs and 2x HDDs.", "category6",999 ),
...
Tempered Glass Side Panel: Gaming PC Case with 0.7mmSPCC transparent tool-free glass side panel allows for a great view of your RGB components and internal hardware.
Optimal Cooling Performance: Superior airflow with space for up to 7 case fans. The detachable fan bracket of the case can install 120mm or 140mm fans*3, and one 120mm on the top of the case, rear-mounted support optional 120mm fan*3 or 140mm fan*2
DUST-PROOF Design: The upper and lower parts are equipped with Pull-out dustproof filters, including the magnetic dust proof net on the front panel, which can effectively prevent dust from entering the case and easy to keep clean.
Professional Cable Management: With an I/O port storage box on the top, which can easily accommodate external wiring such as DVI/HDMIM/USB.", 999 ),
    ('CASE-004', "Corsair 4000D Airflow CC-9011201-WW White Steel / Plastic / Tempered Glass ATX Mid Tower Computer Case","A Fitting Choice
High-Airflow Front Panel
CORSAIR RapidRoute Cable Management System
Two Included 120mm Fans
Extreme Cooling Potential
...
All the Storage You Need: Fits up to 2x SSDs and 2x HDDs.
Tool-Free Tempered Glass Side Panel: Show off your high-profile components and RGB lighting", "category6",999),
   ('CASE-005', "Vetroo AL-MESH-7C Compact ATX PC Case, Front Power Supply, Top 360mm Radiator Support, Type-C & USB 3.0 I/O Panel, High-Airflow Mesh Gaming Case w/ Rear 120mm ARGB & PWM Fan",
    "Front Power Supply: Saving the space of bottom and larger the application area of the case, improve the internal heat dissipation of the case.
Top 360mm Radiator Support: Max 360mm radiator can be installed on the top, provide the better airflow for the case and save the life of radiator.
Type-C & USB 3.0 Ready: Comes with Type-C and 2x USB 3.0 ports on the I/O panel, maintain faster transfer speeds without additional upgrades in the future.
Pre-Installed ARGB & PWM Fan: Comes with 120mm ARGB & PWM fan in the rear, provides the case better airflow cooling and colorful.
High-Airflow Mesh Panel: The mesh front and top panel with dust-tight hole design delivers massive airflow to your system for max cooling.
Free-Tool Disassembly: Using the structure of tenon-and-mortise, just need to unscrew the top hand screw to disassemble the case.", "category6",999),
    ('CASE-006', "Fractal Design North ATX mATX Mid Tower PC Case - North Charcoal Black with Walnut Front and Dark Tinted TG Side Panel",
...
Comes with two dedicated 2.5 inches mounts and two 3.5 inches/2.5 inches mounts
Two Aspect 140 mm PWM fans included
Holds 6x 120 mm / 4x 140 mm fans
Comes with two combined 3.5 inches/2.5 inches mounts
Designated cable management area behind motherboard wall
Easy to build in", "category6",999),
    ('CASE-007', "JONSBO D41 MESH SC BLACK ATX Computer Case with Sub HD-LCD Display, Support MB: ATX/M-ATX,Support GPU RTX 4090(335-400mm), AIO360/280/240, Power ATX/SFX: 100mm-220mm Multiple Tool-free Design, Black",
    "D41 'Pine cone'  series-Mesh Screen Version:
All-metal Compact ATX chassis with tempered glass-1 Side
Enter a new era of sub screen chassis:The 16:10/1280x800 resolution HD LCD display is combined with the chassis,One screen, dual purpose,new visual experience brings to you.
Note : If the screen has compatibility problems during installation, please contact the customer service for solutions. (AIDA64 software needs to be purchased by users)
Air cooler:168mm high-order
Support AIO:360/280 /240(Top)
Drive Bay:2.5SSD*3+3.5HDD*2
Expansion Solt:7
GPU:335-400mm
MB Support: M-ATX/ATX(30.5x24.5cm)
PSU: ATX/SFX:100-220mm L max
The 4-level height adjustment of the power supply position is added,Whether it is to set up a personal small workstation or a feverish E-sports PC, D41 can easily select the hardware.
The power supply bit supports two-way installation
Multiple tool-free disassembly and installation design
Color : Black
Size :H407*W205*D452mm", "category6",999),
    ('CASE-008', "CORSAIR iCUE 4000D RGB AIRFLOW Mid-Tower Case, Black - 3x AF120 RGB ELITE Fans - iCUE Lighting Node PRO Controller - High-airflow Design",
    "The award-winning 4000D RGB AIRFLOW case provides amazing out-of-the-box cooling and RGB lighting for your next build, with three AF120 RGB ELITE PWM fans and an iCUE Lighting Node PRO RGB lighting controller included
...
The AF120 RGB ELITE fans deliver powerful airflow at speeds up to 2,100 RPM and 65.57 CFM and feature CORSAIR AirGuide technology.
...
Show off your high-profile components and RGB lighting behind a beautiful tool-free tempered glass side panel", "category6",999),
...
Easy-to-clean front-access removable filters on front, top and base", "category6",999),
...
Puts your connections within easy reach, including a USB 3.2 Gen 2 Type-C port, USB 3.2 Gen 1 Type A port, and a combination audio/mic jack
Fits up to 2x SSDs and 2x HDDs
Show off your high-profile components and RGB lighting behind a tool-free tempered glass side panel", "category6",999),
...
Side panel made of tempered glass", "category6",999),
...
Reversable layout with quick assembly, allowing users display the main chamber at left or right side", "category6",999),
...
EXCELLENT CABLE MANAGEMENT: Show off your PC case without any distractions by tucking away HDD/SSD and power supply cables within the top PSU shroud for clean cable management and increased air circulation.", "category6",999),
...
2 (2x included) Internal 3.5'' Drive Bays", "category6",999),
...
Large side window for full interior visibility","category6",999),
...
LATEST GEN, GPU READY - With enough room for graphics cards up to 392mm in length, and 180mm in height (for air cooling mode), the LANCOOL 216 is compatible with even the largest NVIDIA 4000 series cards.","category6",999),
...
More Convenient, More Safe - The unique Side Swivel Tempered Glass Side Panel design is not only easier for users to unmount, the zero drill-hole design drastically improves the panel's strength integrity and safety.","category6",999),
...
Removable Dust Filters","category6",999),
...
Optional USB-C kit (sold separately) adds full speed front port","category6",999),
...
2 x 3.5'' HDD or 4 x 2.5'' SSD Internal 3.5 '' Drive Bays","category6",999)
